...
LOG_FILE="${CLAW_EVAL_LOG_FILE:-${ROOT_DIR}/claw_eval_isolated_general.log}"
PID_FILE="${CLAW_EVAL_PID_FILE:-${ROOT_DIR}/claw_eval_isolated_general.pid}"
...
echo $! > "${PID_FILE}"
echo "started claw-eval isolated general run"
