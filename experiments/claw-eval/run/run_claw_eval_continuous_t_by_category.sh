...
LOG_FILE="${CLAW_EVAL_LOG_FILE:-${ROOT_DIR}/claw_eval_continuous_t_by_category.log}"
PID_FILE="${CLAW_EVAL_PID_FILE:-${ROOT_DIR}/claw_eval_continuous_t_by_category.pid}"
...
echo $! > "${PID_FILE}"
echo "started claw-eval continuous T* by-category baseline"
